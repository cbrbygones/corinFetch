...
if [[ $SYS_DISTRO ]]; then
	...
	case ${LOGO} in
		...
		arch)
			ASCII=$(base64 -d <<< "H4sIAAAAAAAAA5XUQQ6AIAwEwPu+gjP7//8ZNEaguy322DoUaqA1E+yuAkvIv6bTI2Nu4pAxDzFH0oZvnBsyRcqQOar6KBTNGFlPUTQMUZpIAtqNIoWRZFc4IomxZEU4IwuCIXfG/CZIkiehql9ZdoIi07VRS0EdX8+lvQXIiZk+fTKeyBKWvHvSVoTivYhumH03pWs4/v5zF5iTi5evBQAA H4sIAAAAAAAAA5XUQQ6AIAwEwPu+gjP7//8ZNEaguy322DoUaqA1E+yuAkvIv6bTI2Nu4pAxDzFH0oZvnBsyRcqQOar6KBTNGFlPUTQMUZpIAtqNIoWRZFc4IomxZE" | gunzip)
			echo "$ASCII"
		;;
