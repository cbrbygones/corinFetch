...
if [[ $SYS_DISTRO ]]; then
	...
	case ${LOGO} in
		...
		linuxmint)
			ASCII=$(base64 -d <<< "H4sIAAAAAAAAA8XUSw6DMAwE0L1Pwd7SHADJ979Wi8pnHNshpJU6G0SUh8EkWZaZyJSqGHTPOso0yR3LTCaZoUZbkLM+8hWFEd4Zg8KlHDtu4EY904YhxLsPs4ZFdTojpgnjq5G72HrH+KtxsrYLXaZ/YnjCUHcyJO3k8d+sctu4RcblrglKD/PF/JrUfH3EteV3QAm1UZP77fvN3S/o5/3m4ArvO3xMDkXkBdnE3wUEBgAA" | gunzip)
			echo "$ASCII"
		;;
	*)
